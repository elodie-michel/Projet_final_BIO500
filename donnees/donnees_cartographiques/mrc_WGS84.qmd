...
<qgis version="3.34.6-Prizren">
  ...
  <links>
    <link name="" description="" type="Local Area Network" url="file://\\210965PT\D$\users\maj_sda_epel\couvertures\bdga1m\ainfo\admin\version_courante\adm\munic_s" size="" format="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
  ...
  <extent>
    <spatial maxx="0" crs="EPSG:4269" maxy="0" maxz="0" dimensions="2" minz="0" minx="0" miny="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>

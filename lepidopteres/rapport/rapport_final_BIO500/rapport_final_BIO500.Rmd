...
========================================
```{r fig:fig_richesse_temporelle, echo=FALSE, fig.cap="\\label{fig:fig_richesse_temporelle}Richesse spécifique au fil des années.", fig.align='center', out.width='70%'}
library(targets)
...
```{r fig:fig_richesse_spatiale, echo=FALSE, fig.cap="\\label{fig:fig_richesse_spatiale}Richesse spatiale ", fig.align='center', out.width='70%'}
...
```{r fig:fig_phenologie, echo=FALSE, fig.cap="\\label{fig:fig_phenologie}Phénologie", fig.align='center', out.width='100%'}
    library(dplyr)
    library(ggplot2)
    library(lubridate)

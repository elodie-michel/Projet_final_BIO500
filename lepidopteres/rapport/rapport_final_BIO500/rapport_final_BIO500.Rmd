...
```{r fig:fig_phenologie, echo=FALSE, fig.cap="\\label{fig:fig_phenologie}Variabilité temporelle de la présence des 10 espèces de lépidoptères les plus abondantes en comparant leurs dates d’arrivée et de départ durant une année complète.", fig.align='center',out.width='80%',fig.width=9, fig.height=8, fig.pos="H"}
